...
public class NewProjectWizardPage extends WizardNewProjectCreationPage {
  ...
  private IErrorMessageReporter getErrorReporter() {
    return new IErrorMessageReporter() {
      /* (non-Javadoc)
       * @see org.eclipse.ui.internal.ide.dialogs.ProjectContentsLocationArea.IErrorMessageReporter
  ...
  private boolean isWizardPageComplete() {
    ...
    if(getSelectedDependencyOption() == DependencyOptions.LOCATE_EXT_DEPENDENCIES) {
